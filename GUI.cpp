...
//
//public:
//    explicit GUI(Board &board) : board(board) {}
//
//    void runGui() {
//
//
...
//                sf::VideoMode(CELL_SIZE * COLUMNS * SCREEN_RESIZE, SCREEN_RESIZE * (FONT_HEIGHT + CELL_SIZE * COLUMNS)),
...
//        Alexander.setPosition(static_cast<float>(CELL_SIZE * COLUMNS - Alexander_texture.getSize().y),
//                              CELL_SIZE * ROWS);
...
//                unsigned char mouse_cell_x = std::clamp(static_cast<int>(floor(
//                                                                sf::Mouse::getPosition(window).x / static_cast<float>(CELL_SIZE * SCREEN_RESIZE))), 0,
//                                                        COLUMNS - 1);
//                unsigned char mouse_cell_y = std::clamp(static_cast<int>(floor(
//                                                                sf::Mouse::getPosition(window).y / static_cast<float>(CELL_SIZE * SCREEN_RESIZE))), 0,
//                                                        ROWS - 1);
//
//
//                std::cout << "X=" << mouse_cell_x << " Y=" << mouse_cell_y << std::endl;
//
//
...
//                    1 == sf::Mouse::isButtonPressed(sf::Mouse::Right)) {
...
//                        if (1 == field.get_game_over()) {
//                            draw_text(1,
//                                      static_cast<unsigned short>(round(0.5f * (CELL_SIZE * COLUMNS - 8 * FONT_WIDTH))),
//                                      static_cast<unsigned short>(round(0.5f * (CELL_SIZE * ROWS - FONT_HEIGHT))),
//                                      "VICTORY!", window);
//                        } else {
//                            draw_text(1,
//                                      static_cast<unsigned short>(round(0.5f * (CELL_SIZE * COLUMNS - 4 * FONT_WIDTH))),
//                                      static_cast<unsigned short>(round(0.5f * (CELL_SIZE * ROWS - 2 * FONT_HEIGHT))),
//                                      "GAME\nOVER", window);
//                        }
//                    }
//
...
//                    Alexander.setTextureRect(sf::IntRect(Alexander_state * Alexander_texture.getSize().y, 0,
//                                                         Alexander_texture.getSize().y, Alexander_texture.getSize().y));
//
